...
- Save the file in your bcog200 directory, and name it "lastname_firstname_lab10.py". 
- Copy the code below and paste the code into your lab10.py file, and save the file.
- Finally, follow the instructions in the code to complete Lab 10.
...
Next: 11.0<br>
Previous: [10.5. SubPlot Figures](10.5.%SubPlot%Figures.md)
