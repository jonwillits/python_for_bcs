...
parameter shifts the curve left or right. And as with a line, the slope affects teh direction and steepness of the 
curve.
...
Next: [11.3. Regression in scikit-learn](../CH11/11.3.%20Regression%20in%20Scikit-learn.md)<br>
