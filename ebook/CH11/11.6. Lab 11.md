...
def q6():
    print("Question 6")
    """
        Load the mcdi dataset into a dataframe, and then use it to compute a regression predicting MCDIp using
        Age, Logfreq, and ProKWo as predictor variables. Print the resulting equation.
    """
