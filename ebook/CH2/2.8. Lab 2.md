...
loop over the list of tokens, and within each token, to loop over the characters, and print them out
so that it looks like the output below. Your output should look like (but for all the words, not just two):
    t
    h
    e
