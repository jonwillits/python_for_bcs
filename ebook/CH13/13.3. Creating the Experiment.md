...
should contain 4 items each. These are good numbers to use while you test the code and make sure everything works. Later, when 
you are sure it all works and running the experiment for your lab assignment, you will set these numbers to 30.
