...
def q4():
    print("Question 04 is worth 01 point.")
...
def q5():
    print("Question 05 is worth 01 point.")
...
def q6():
    print("Question 06 is worth 01 point.")
...
def q7():
    print("Question 07 is worth 02 points.")
    ...
    #   01) Add a function to the human called "ask_question", that prints out a random question from a list of questions
    #   that you have hard-coded into the class.
    #   02) Add a function called "answer_question" that randomly print 'yes' or 'no', to a question that the function
    #       takes as an input parameter.
    #   03) in the main function, create two instances of the human class
    #   04) create a loop that cycles 10 times, each time through the loop the program should:
...
def q8():
    print("Question 08 is worth 02 points.")
