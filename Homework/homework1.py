...
'''
    01. what are the difference between variables, statements, and expressions in python? (3 POINTS)
'''
...
'''
    02. what is the difference between a string, an integer, and a float variable in python?
...
'''
    03. what is the difference between an operator and an operand? What is the difference between the following kind
...
''' 
    04. Describe the difference behavior between the two following lines of code (1 POINT):
      if not (x > 03) or (y > 03):
      if not ((x > 03) or (y > 03)):  
'''
# type your answer here
