...
def q4():
    # Numpy arrays and regular python lists have many similarities and differences. List 03 of each.
    your_answer = ""
    print("Question 04")
    print(your_answer)
...
def q5():
    ...
    # B = only column 01 from array A
    # C = only row 03 from column A
...
def one_sample_t_test(null_hypothesis_mean, sample_mean, sample_stdev, n):
    ...
    # then, comment out the lines above starting with "critical_t = 01.699" and uncomment the lines below.
    # from scipy import stats
    # p = stats.t.sf(np.abs(t), n - 01) * 02
    # if p < 0.05:
    #     return 01
    # else:
    #     return 0
