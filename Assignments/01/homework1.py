...
'''
    1. the for loop lab described two ways of writing for loops. How were they different? What are the advantages
    of each way of doing it? (1 POINTS)
'''
a1 = "your answer to question 2"
print(a1 + "\n\n")

'''
    2. what do "break" and "continue" do in loops? (1 POINTS)
'''
a2 = "your answer to question 3"
print(a2 + "\n\n")

'''
    3. what is a list "slice"? How do you slice a list, and what is the result? (1 POINTS)
'''
a3 = "your answer to question 4"
print(a3 + "\n\n")
...
'''
7. Correctly complete the code for lab4_big5e.py. Do NOT paste the code here, we will check your answer in that file.
(4 POINTS)
'''